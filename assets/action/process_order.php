...
if(!empty($_SESSION["shopping_cart"]))
{
	...
	$address_line_two = $_POST['addressnew'];
 ...
 foreach($_SESSION["shopping_cart"] as $keys => $values)
 {
	...
	*/	
		...
		$insertOrderSQL = "INSERT INTO `orders_tbl`(`order_id`, `customer_id`,`province`,`district`, `product_qty`, `product_discount`, `shipping_charge`, `product_total`, `type`, `date_time`) VALUES ('$orderid','$customerId','$province','$district','$productQtySum','$discountSum','$shipCharge','$total_price2','cashondelivery','$date_time')";		
