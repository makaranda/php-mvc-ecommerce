 ...
 $output .= '<div class="row border">
              <div class="col-xs-12 col-sm-2">
                <div class="img-holder">
                  <img src="'.URL.'assets/uploads/products/'.$product_image.'" alt="'.$product_name.'">
                </div>
              </div>
              <div class="col-xs-12 col-sm-2">
              ...
              <div class="col-xs-12 col-sm-2">
                ...
                <a href="" id="'.$product_code.'"" class="deleteCartItem"><i class="fa fa-close"></i></a>
              </div>
            </div>';
...
$output .= '<div class="cart-btn-row text-center">
		<a href="'.URL.'products" class="btn-type2">Go to Product Page</a>
	</div>';
	$status = 'not';
}
$data = array(
