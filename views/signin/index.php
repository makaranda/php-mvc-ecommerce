							...
							<div class="row justify-content-center shadow-lg login-left-side border p-3">
								...
								<div class="col-md-12 col-12 mt-4">
									<form method="post" id="login_form">
										<fieldset>
											<label for="username" class="font-weight-bold">User Name (Phone/Whatsapp/Email)&nbsp;<span class="required text-danger">*</span></label>
											<input class="form-control" name="user_name" placeholder="Enter Your Phone/Whatsapp/Email" type="text" required data-parsley-trigger="keyup" autocomplete="off">
											<label for="password" class="mt-3 font-weight-bold">User Password &nbsp;<span class="required text-danger">*</span></label>
											<div class="input-group">
												<input type="password" name="user_password" class="form-control showInput" placeholder="Enter Your Password" aria-describedby="showBtn" id="qlogpwd044515" size="30"  required data-parsley-trigger="keyup" autocomplete="off">
                                              ...
                                              <div class="form-group mt-3">
                                    			 <div class="row justify-content-center">
                                    			    <div class="col-12 col-md-12">
                                    			        <label for="exampleFormControlInput1" class="font-weight-bold">Recaptcha Code&nbsp;<span class="required text-danger">*</span></label>    
                                    			    </div>
											...
											<button type="submit" id="loginsubmit" name="Login" value="Login" class="btn site-btn mt-3">Login</button>
											<a href="<?php echo URL.'user_password_reset';?>" class="btn btn-primary text-uppercase font-weight-600 rounded-0 mt-3 float-right pt-2 pb-2">Password Reset</a>
										</fieldset>
									</form>
								</div>									
							</div>
									...
									<form method="post" id="validate_form">
										<fieldset>
										  <div class="row justify-content-start">
											<div class="col-12 col-md-6">
												<label for="username" class="font-weight-bold">First Name <span class="required text-danger">*</span></label>
												<input type="text" placeholder="Name" class="input form-control" name="fname" id="fname" required data-parsley-trigger="keyup">
											</div>
											<div class="col-12 col-md-6">
												<label for="username" class="font-weight-bold">Last Name <span class="required text-danger">*</span></label>
												<input type="text" placeholder="Name" class="input form-control" name="lname" id="lname" required data-parsley-trigger="keyup">
											</div>
											<div class="col-12 col-md-12">
												<label for="username" class="font-weight-bold">Email Address <span class="required text-danger">*</span></label>
											...
											<div class="col-12 col-md-6">
												<label for="username" class="font-weight-bold">Whatsapp Number <span class="required text-danger">*</span></label>
											...
											<div class="col-12 col-md-6">
												<label for="username" class="font-weight-bold">Phone <span class="required text-danger">*</span></label>
											...
											<div class="col-12 col-md-6">
												<label for="username" class="font-weight-bold">District <span class="required text-danger">*</span></label>
												<select class="form-control" name="district" required  id="district">
													<?php echo $district_list;?>
												</select>
											</div>	
											<div class="col-12 col-md-6">
												<label for="username" class="font-weight-bold">NIC </label>
												<input type="text" placeholder="NIC" class="input form-control" name="nic" id="nic">
											</div>	
    										  <div class="col-12 col-md-6">
                                                <label for="password" class="font-weight-bold">Password <span class="required text-danger">*</span></label>
                                                <input type="password" name="password" id="password" placeholder="Password" required data-parsley-length="[4, 16]" data-parsley-trigger="keyup" class="form-control" />
                                              </div>
                                              <div class="col-12 col-md-6">
                                                <label for="cpassword" class="font-weight-bold">Confirm Password <span class="required text-danger">*</span></label>
        					                ...
        					                <div class="col-12 col-md-12">
                                               <div class="form-group mt-3">
                                    			 <div class="row justify-content-center">
                                    			    ...
                                    			    <div class="col-12 col-sm-6 col-md-6 recaptcha_col_left pr-0"> 
                                    					<input type="text" placeholder="Recaptcha Code *" style="margin-top: 2px;" name="captcha_code2" id="captcha_code2" class="form-control" data-parsley-trigger="keyup" required="">
                                    				  </div>	
                                    				   <div class="col-12 col-sm-6 col-md-6 recaptcha_col_right pl-0">
                                    						<img src="<?php echo URL;?>assets/action/recaptcha_image.php" id="captcha_image2" style="width: 170px;height: 40px;padding: 2px 0 0;">
                                    						<button type="button" class="btn btn-transparent recaptch_refresh2 bg-transparent"><i class="fa fa-refresh"></i></button>
                                    			       </div>
                                    		       </div>
                                    		   </div>  
                                    		</div> 
											<div class="col-12 col-md-12">
                                              <div class="form-group mt-2">
                                               <div class="checkbox">
                                                <label><input type="checkbox" id="check_rules" name="check_rules" required /> I Accept the <a href="<?php echo URL;?>privacy_policy" class="btn btn-link pl-0 pr-0 pb-2" target="_new">privacy policy</a> & <a href="<?php echo URL;?>terms_condition" class="btn btn-link pl-0 pr-0 pb-2" target="_new">Terms & Conditions</a>.</label>
                                               </div>
                                              </div>
                                            </div> 
											<p></p>
											<div class="col-12 col-md-12">
												<button type="submit" id="regsubmit" name="Login" value="Login" class="btn site-btn">Register</button>
											</div>
										  </div>
										</fieldset>
									</form>
