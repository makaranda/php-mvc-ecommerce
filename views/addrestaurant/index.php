<?php
    ...
    //var_dump($_FILES);
    if(isset($_POST['pageType'],$_POST['pages_max'],$_POST['title'],$_FILES['upload_image']["name"],$_POST['restaurants_details'],$_POST['phone_no1'],$_POST['email'],$_POST['restaurantLocation'],$_POST['long'],$_POST['lati'])){  
        ...
        $restaurants_details = $_POST['restaurants_details'];
        ...
        VALUES ('".$pages_max."','".$pageType."','".$pages_max."','".$title."','".$country."','".$province."','".$district."','".$city."','".$restaurants_details."','0','".$feature_image."','on','".$phone_no1."','".$phone_no2."','".$website."','".$email."','".$long."','".$lati."','".$restaurantLocation."','".$date_time."')
        ";
         ...
         <div class="col-lg-12 mb-4">
             <div class="card shadow mb-4">
					...
					<a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
					  <h6 class="m-0 font-weight-bold text-primary">Add Restaurant</h6>
					</a>
             ...
             <div class="card shadow mb-4">
              ...
              <input type="hidden" class="form-control capitalize" name="pageType" value="restaurants" id="pageType">
                        ...
                        <p class="dropify-infos-message">Drag and drop or click to replace</p>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <textarea rows="5" class="form-control restaurants_details" name="restaurants_details" required></textarea>
                            </div>                     
                          </div>
                  ...
                  <option value="" class="hidewithprovince">Select Town</option>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="restaurantLocation" id="restaurantLocation" required>
                            </div>                        
                          </div>                        
