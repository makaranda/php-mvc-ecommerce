         ...
         <div class="col-lg-12 mb-4">
             <div class="card shadow mb-4">
					...
					<a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
					  <h6 class="m-0 font-weight-bold text-primary">Theme Details</h6>
					</a>
                  ...
                  <div class="card-body">
                    ...
                    <div class="col-12 col-md-3 align-self-center">
                      <div class="form-group text-left">
                         <label class="font-weight-bold w-100 float-left uploadingIMG2 d-none">New Logo Preview (upload file size is 600px X 300px)</label>
                    ...
                    <div class="form-group mb-0 text-left font-weight-bold">
                      <label class="w-100 mb-0">Current Logo</label>
