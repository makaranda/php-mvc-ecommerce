							...
							<div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM pages_tbl WHERE page_type = 'hotels'";
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="<?php echo URL;?>dashboard/edithotels/<?php echo $row['page_id'];?>" class="btn btn-primary"><i class="fas fa-pen"></i></a> <a href="<?php echo URL;?>dashboard/deletehotels/<?php echo $row['page_id'];?>" class="btn btn-danger"><i class="fas fa-trash"></i></a></td>
                                            </tr>
                                    <?php           
