                  ...
                  <div class="card-body">
                    ...
                    <div class="col-12 col-md-3 align-self-center">
                      <div class="form-group text-left">
                         ...
                         <img id="blah" src="<?php echo URL;?>assets/uploads/fans_sample.jpg" alt="your image" class="w-100 uploadingIMG shadow" width="275" height="275" align="center"/>
                      </div>
                        ...
                        <p class="dropify-infos-message">Drag and drop or click to replace</p>
                          ...
                          <div class="col-md-6 mt-3">
                            <div class="form-group">
                              ...
                              <input class="form-control contact_number0000" type="number" name="proQty" min="1"/>
                            </div>                     
                          </div>

                          <div class="col-md-6 mt-3">
                            <div class="form-group">
                              <label class="font-weight-bold">Is Discount</label>
